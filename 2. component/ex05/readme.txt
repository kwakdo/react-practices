...
01. 기본 개념
    1) state
        ...
        - 상태가 변경되면 컴포넌트 반응형 렌더링이 트리거가 되고, 컴포넌트의 자식 컴포넌트가 다시 렌더링 된다.
...
[ex05]$ npm i react react-dom prop-type @fortawesome/fontawesome-svg-core @fortawesome/react-fontawesome @fortawesome/free-solid-svg-icons
